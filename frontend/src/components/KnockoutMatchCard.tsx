// Componente unificado para partidos de eliminación directa
// HOST: Publica resultado (goles + penales si aplica)
// PLAYER: Elige quién avanza
...
export function KnockoutMatchCard({
  ...
  function calculateWinner(): string | null {
    ...
    return null; // Empate en penales (inválido)
  }
  ...
  async function handleSaveResult() {
    ...
    // Si es errata (resultado ya existía), requiere razón
