...
type StructuralPicksManagerProps = {
  ...
  onDataChanged?: () => void;
  // Callback para mostrar desglose de puntuacion
  ...
  useEffect(() => {
    async function loadPickData() {
      try {
        ...
        // Para GROUP phases, la logica original
...
function extractGroups(tournamentData: any, _phaseId: string): Group[] {
  // En WC2026 sandbox, los grupos no estan dentro de las fases
  // Los equipos tienen groupId, asi que agrupamos por ese campo
