    ...
    <div style={{ marginTop: 14, padding: 20, border: "1px solid #ddd", borderRadius: 14, background: colors.white }}>
      {overview.pool.pickTypesConfig ? (
        ...
        <>
          ...
          {/* Scoring System */}
          <div style={{ marginBottom: 20, padding: 16, background: colors.bgLight, borderRadius: 12, border: "1px solid #e9ecef" }}>
            ...
            <div style={{ fontSize: 14, lineHeight: 1.8 }}>
              <div style={{ marginBottom: 8 }}>
                ...
                <span style={{ background: colors.white, padding: "2px 8px", borderRadius: 4, border: "1px solid #dee2e6" }}>
                  {overview.leaderboard?.scoringPreset?.name ?? overview.pool.scoringPresetKey ?? "CLASSIC"}
                </span>
              </div>
              <div style={{ color: colors.textMuted, fontSize: 13, marginBottom: 12, fontStyle: "italic" }}>
          ...
          <div style={{ marginBottom: 20, padding: 16, background: colors.bgLight, borderRadius: 12, border: "1px solid #e9ecef" }}>
            ...
            <div style={{ fontSize: 14, lineHeight: 1.8 }}>
              <div style={{ marginBottom: 8 }}>
                ...
                <span style={{ background: colors.white, padding: "2px 8px", borderRadius: 4, border: "1px solid #dee2e6", fontWeight: 600 }}>
          ...
          {/* Tournament Info */}
          <div style={{ padding: 16, background: colors.bgLight, borderRadius: 12, border: "1px solid #e9ecef" }}>
            <h4 style={{ margin: 0, fontSize: 16, fontWeight: 700, marginBottom: 12, color: colors.brand }}>
            ...
            <div style={{ fontSize: 14, lineHeight: 1.8 }}>
              ...
              {overview.pool.description && (
                <div style={{ marginTop: 12, padding: 12, background: colors.white, borderRadius: 8, border: "1px solid #dee2e6" }}>
                  <div style={{ fontSize: 12, fontWeight: 600, color: colors.textMuted, marginBottom: 4 }}>{t("rules.tournament.description")}:</div>
                  <div style={{ color: colors.textDark }}>{overview.pool.description}</div>
                </div>
              )}
            </div>
          </div>
