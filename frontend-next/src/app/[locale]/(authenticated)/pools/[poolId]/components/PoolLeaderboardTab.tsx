      ...
      <div style={{ marginTop: 14, padding: isMobile ? 12 : 20, border: "1px solid #ddd", borderRadius: 14, background: colors.white }}>
        ...
        {isMobile ? (
          ...
          <>
                  ...
                  <tr style={{ borderBottom: "2px solid #e0e0e0" }}>
                    ...
                    {(overview.leaderboard.phases || []).map((phaseId: string) => (
                      <th
                        ...
                        style={{ padding: "12px 6px", textAlign: "center", fontWeight: 600, color: colors.textMuted, fontSize: 12, minWidth: 50 }}
                      >
                    ...
                    return (
                      <tr
                        ...
                        style={{
                          ...
                          background: idx < 3 ? (idx === 0 ? "#fff9e6" : idx === 1 ? colors.bgLight : "#fafafa") : "transparent",
                        }}
                      >
            ...
            {verbose && (
              <details style={{ marginTop: 16, padding: 12, background: colors.bgLighter, borderRadius: 8 }}>
                ...
                <div style={{ marginTop: 10 }}>
                  {overview.leaderboard.rows.map((r) => (
                    <div key={r.userId} style={{ marginBottom: 12 }}>
                      ...
                      {r.breakdown && (
                        <pre style={{ fontSize: 11, whiteSpace: "pre-wrap", background: colors.white, padding: 8, borderRadius: 4, overflow: "auto" }}>
