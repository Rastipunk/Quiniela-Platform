...
export const metadata: Metadata = {
  title:
    "Prode Online Gratis — Arma tu Prode Deportivo con Amigos",
  description:
    "Crea tu prode online gratis con amigos. Pronosticos de futbol sin dinero real ni apuestas. Arma tu prode deportivo en minutos con Picks4All.",
  openGraph: {
    title:
      "Prode Online Gratis — Arma tu Prode Deportivo con Amigos | Picks4All",
    description:
      "Crea tu prode online gratis con amigos. Pronosticos de futbol sin dinero real ni apuestas. Arma tu prode deportivo en minutos con Picks4All.",
...
export default function ProdeDeportivoPage() {
  const articleJsonLd = {
